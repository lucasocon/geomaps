...
class PharmaciesControllerTest < ActionController::TestCase
  ...
  test "should create pharmacy" do
    assert_difference('Pharmacy.count') do
      post :create, pharmacy: { address: @pharmacy.address, description: @pharmacy.description, latitude: @pharmacy.latitude, longitude: @pharmacy.longitude, name: @pharmacy.name }
    end
  ...
  test "should update pharmacy" do
    patch :update, id: @pharmacy, pharmacy: { address: @pharmacy.address, description: @pharmacy.description, latitude: @pharmacy.latitude, longitude: @pharmacy.longitude, name: @pharmacy.name }
    assert_redirected_to pharmacy_path(assigns(:pharmacy))
  end
